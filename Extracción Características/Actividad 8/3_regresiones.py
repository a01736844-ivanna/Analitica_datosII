...
if tipo_reg == "Regresión no lineal":
    ...
    numeric_cols = [
        c for c in df_ref_nl.select_dtypes(include="number").columns
    ...
    st.caption("Nota: para modelos logarítmicos y de cociente se filtran valores de X no válidos (≤0 o =0).")

    # ---- Visual por ciudad (hasta 4 columnas) ----
    n = len(ciudades_reg_sel)
